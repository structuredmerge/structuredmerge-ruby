...
- Add an explicit Rust ast-template session-report provider with Ruby-owned execution.
...
- [kc] kettle-jem/template: updated 1730 project files:
  - code and tests (86)
  - configuration (52)
  - dependencies (639)
  - documentation (39)
...
- TAG: [v7.1.4][7.1.4t]
- COVERAGE: 76.30% -- 351/460 lines in 3 files
- BRANCH COVERAGE: 61.70% -- 116/188 branches in 3 files
- 10.77% documented
...
[Unreleased]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.9...HEAD
[7.1.9]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.8...v7.1.9
[7.1.9t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.9
