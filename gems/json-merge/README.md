...
|---|---|
| Package | json-merge |
| Description | Portable JSON and JSONC analysis, owner matching, fallback, and merge behavior for Structured Merge. |
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/json-merge |
