...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge JSON analysis and merge for Ruby'
  spec.description = '☯️ Portable JSON and JSONC analysis, owner matching, fallback, and merge behavior for Structured Merge.'
