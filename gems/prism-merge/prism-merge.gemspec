...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge Prism-backed Ruby analysis for Ruby'
  spec.description = '☯️ Prism-backed Ruby provider gem for the Structured Merge Ruby family.'
