...
Gem::Specification.new do |spec|
  ...
  spec.metadata['mailing_list_uri'] = 'https://www.rubyforum.org/tag/tree_haver'
  ...
  spec.add_dependency 'tree_sitter_language_pack', '>= 1.13.2', '< 2.0'
  ...
  spec.add_development_dependency('toml', '~> 0.3') # ruby >= 0
  spec.add_development_dependency('toml-rb', '~> 4.1') # ruby >= 3.2.0
end
