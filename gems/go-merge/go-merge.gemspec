...
# kettle-jem:freeze
# To retain chunks of comments & code during go-merge templating:
...
Gem::Specification.new do |spec|
  spec.name = 'go-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/go/merge/version.rb", mod) }::Go::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge Go module analysis and merge for Ruby'
  spec.description = '☯️ Portable Go module owner analysis and merge behavior for Structured Merge.'
  ...
  # The 'git' gem is optional; go-merge falls back to shelling out to `git` if it is not present.
