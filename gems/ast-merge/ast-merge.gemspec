...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge AST/core contracts for the Ruby monorepo'
  spec.description = '☯️ Core diagnostics, conformance, planning, reporting, and review-state contracts for Structured Merge.'
  ...
  spec.metadata['mailing_list_uri'] = 'https://www.rubyforum.org/tag/ast-merge'
