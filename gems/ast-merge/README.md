...
|---|---|
| Package | ast-merge |
| Description | Core diagnostics, conformance, planning, reporting, and review-state contracts for Structured Merge. |
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/ast-merge |
