...
# kettle-jem:freeze
# To retain chunks of comments & code during zip-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# zip-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

Gem::Specification.new do |spec|
  spec.name = 'zip-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/zip/merge/version.rb", mod) }::Zip::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge ZIP merge planning and rendering helpers for Ruby'
  spec.description = '☯️ Portable ZIP inventory, planning, nested dispatch, and raw-preservation rendering helpers for Structured Merge.'
  ...
  # Utilities
  spec.add_dependency 'binary-merge', "= #{spec.version}"
  ...
  spec.add_development_dependency('kettle-dev', '~> 2.0', '>= 2.2.25') # ruby >= 4.0.0
  ...
  spec.add_development_dependency('kettle-test', '~> 2.0', '>= 2.0.9') # ruby >= 4.0.0
  ...
  # The 'git' gem is optional; zip-merge falls back to shelling out to `git` if it is not present.
