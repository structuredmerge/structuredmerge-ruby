...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency("ast-crispr-markdown-markly", "~> 7.1", ">= 7.1.4")  # ruby >= 4.0.0
  spec.add_dependency("ast-crispr-ruby-prism", "~> 7.1", ">= 7.1.4")        # ruby >= 4.0.0
  spec.add_dependency("ast-merge", "~> 7.1", ">= 7.1.6")                  # ruby >= 4.0.0
  spec.add_dependency("bash-merge", "~> 7.1", ">= 7.1.6")                 # ruby >= 4.0.0
  spec.add_dependency("citrus-toml-merge", "~> 7.1", ">= 7.1.6")          # ruby >= 4.0.0
  spec.add_dependency("commonmarker-merge", "~> 7.1", ">= 7.1.6")         # ruby >= 4.0.0
  spec.add_dependency("dotenv-merge", "~> 7.1", ">= 7.1.6")              # ruby >= 4.0.0
  spec.add_dependency("json-merge", "~> 7.1", ">= 7.1.6")                 # ruby >= 4.0.0
  ...
  spec.add_dependency("kramdown-merge", "~> 7.1", ">= 7.1.6")             # ruby >= 4.0.0
  ...
  spec.add_dependency("ruby-merge", "~> 7.1", ">= 7.1.6")                 # ruby >= 4.0.0
  spec.add_dependency("token-resolver", "~> 2.0", ">= 2.0.10")           # ruby >= 3.2.0
  spec.add_dependency("toml-merge", "~> 7.1", ">= 7.1.6")                 # ruby >= 4.0.0
  spec.add_dependency("toml-rb", "~> 4.2")                               # ruby >= 3.2.0
  spec.add_dependency("tree_haver", "~> 7.1", ">= 7.1.6")                 # ruby >= 4.0.0
