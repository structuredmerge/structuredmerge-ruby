...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency("ast-crispr-markdown-markly", "~> 7.1", ">= 7.1.3")  # ruby >= 4.0.0
  spec.add_dependency("ast-crispr-ruby-prism", "~> 7.1", ">= 7.1.3")        # ruby >= 4.0.0
  spec.add_dependency("ast-merge", "~> 7.1", ">= 7.1.3")                  # ruby >= 4.0.0
  spec.add_dependency("bash-merge", "~> 7.1", ">= 7.1.3")                 # ruby >= 4.0.0
  ...
  spec.add_dependency("kettle-changelog", "~> 1.0", ">= 1.0.1")          # ruby >= 4.0.0
  ...
  spec.add_dependency("kramdown-merge", "~> 7.1", ">= 7.1.3")             # ruby >= 4.0.0
  spec.add_dependency("markdown-merge", "~> 7.1", ">= 7.1.3")             # ruby >= 4.0.0
  spec.add_dependency("markly-merge", "~> 7.1", ">= 7.1.3")               # ruby >= 4.0.0
  spec.add_dependency("parslet", "~> 2.0")                               # ruby >= 2.6.0
  spec.add_dependency("prism-merge", "~> 7.1", ">= 7.1.3")                # ruby >= 4.0.0
  spec.add_dependency("psych-merge", "~> 7.1", ">= 7.1.3")                # ruby >= 4.0.0
  ...
  spec.add_dependency("toml-merge", "~> 7.1", ">= 7.1.3")                 # ruby >= 4.0.0
  spec.add_dependency("toml-rb", "~> 4.2")                               # ruby >= 3.2.0
  spec.add_dependency("tree_haver", "~> 7.1", ">= 7.1.3")                 # ruby >= 4.0.0
  spec.add_dependency("yaml-merge", "~> 7.1", ">= 7.1.3")                 # ruby >= 4.0.0
