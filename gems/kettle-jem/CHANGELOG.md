...
- TAG: [v7.1.27][7.1.27t]
- COVERAGE: 93.67% -- 11269/12030 lines in 16 files
- BRANCH COVERAGE: 77.10% -- 4794/6218 branches in 16 files
- 18.11% documented
...
- TAG: [v7.1.22][7.1.22t]
- COVERAGE: 93.66% -- 11247/12008 lines in 16 files
- BRANCH COVERAGE: 77.06% -- 4787/6212 branches in 16 files
- 18.04% documented
...
- TAG: [v7.1.21][7.1.21t]
- COVERAGE: 93.62% -- 11176/11937 lines in 16 files
- BRANCH COVERAGE: 77.01% -- 4759/6180 branches in 16 files
- 18.01% documented
...
- [kc] kettle-jem-deps-floor: Update kettle-jem template dependency floors:
  - kettle-dev (>= 3.0.31 -> >= 3.0.32)
  - kettle-jem (>= 7.1.18 -> >= 7.1.19)
...
- [kc] kettle-jem-deps-floor: Update kettle-jem template dependency floors:
  - kettle-family (>= 1.2.93 -> >= 1.2.94)
  - kettle-jem (>= 7.1.17 -> >= 7.1.18)
...
- TAG: [v7.1.17][7.1.17t]
- COVERAGE: 93.62% -- 11160/11920 lines in 16 files
- BRANCH COVERAGE: 76.97% -- 4749/6170 branches in 16 files
- 17.92% documented
...
- [kc] kettle-jem-deps-floor: Update kettle-jem template dependency floors:
  ...
  - kettle-family (>= 1.2.82 -> >= 1.2.83)
  - kettle-jem (>= 7.1.15 -> >= 7.1.16)
...
- TAG: [v7.1.16][7.1.16t]
- COVERAGE: 93.62% -- 11159/11920 lines in 16 files
- BRANCH COVERAGE: 76.97% -- 4749/6170 branches in 16 files
- 17.92% documented
...
- TAG: [v7.1.15][7.1.15t]
- COVERAGE: 93.62% -- 11131/11890 lines in 16 files
...
- TAG: [v7.1.13][7.1.13t]
- COVERAGE: 93.62% -- 11103/11860 lines in 16 files
- BRANCH COVERAGE: 76.97% -- 4728/6143 branches in 16 files
- 17.96% documented
...
[7.1.21t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.21
[7.1.20]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.19...v7.1.20
[7.1.20t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.20
[7.1.19]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.18...v7.1.19
[7.1.19t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.19
[7.1.18]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.17...v7.1.18
[7.1.18t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.18
[7.1.17]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.16...v7.1.17
[7.1.17t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.17
[7.1.16]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.15...v7.1.16
[7.1.16t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.16
[7.1.15]: https://github.com/structuredmerge/structuredmerge-ruby/compare/v7.1.14...v7.1.15
[7.1.15t]: https://github.com/structuredmerge/structuredmerge-ruby/releases/tag/v7.1.15
