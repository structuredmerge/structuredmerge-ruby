...
- Gem templates and generated templating Gemfiles now require `kettle-dev` >= 2.2.10.
- The packaged gemspec template now uses the same `kettle-dev` 2.2.10 floor as
