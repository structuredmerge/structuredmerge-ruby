...
- Gem templates and generated root Gemfiles now require `kettle-dev` >= 2.2.18.
...
- Generated coverage Gemfiles now pin SimpleCov to the fixed
...
- Gem templates now require `kettle-test` >= 2.0.7.
