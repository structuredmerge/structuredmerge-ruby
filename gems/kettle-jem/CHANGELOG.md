...
- Gem templates and generated templating Gemfiles now require `kettle-dev` >= 2.2.11.
- The packaged gemspec template now uses the same `kettle-dev` 2.2.11 floor as
