  ...
  module Jem
    ...
    def monorepo_root_gemfile_dependency_lines
      [
        ...
        {name: "kettle-dev", source: %(gem "kettle-dev", "~> 3.0", ">= 3.0.30"\n)},
        {name: "kettle-drift", source: %(gem "kettle-drift", "~> 1.0", ">= 1.0.13"\n)},
        {name: "kettle-family", source: %(gem "kettle-family", "~> 1.2", ">= 1.2.85"\n)},
        {name: "kettle-jem", source: %(gem "kettle-jem", "~> 7.1", ">= 7.1.17"\n)},
