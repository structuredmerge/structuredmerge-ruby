  ...
  module Jem
    ...
    def monorepo_root_gemfile_dependency_lines
      [
        ...
        {name: "kettle-dev", source: %(gem "kettle-dev", "~> 2.5", ">= 2.5.24"\n)},
        {name: "kettle-drift", source: %(gem "kettle-drift", "~> 1.0", ">= 1.0.12"\n)},
        {name: "kettle-family", source: %(gem "kettle-family", "~> 1.2", ">= 1.2.38"\n)},
        ...
        {name: "turbo_tests2", source: %(gem "turbo_tests2", "~> 3.2", ">= 3.2.4"\n)}
      ].freeze
    end
