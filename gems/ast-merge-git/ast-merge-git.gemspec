...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/ast/merge/git/version.rb", mod) }::Ast::Merge::Git::Version::VERSION
  ...
  # The 'git' gem is optional; ast-merge-git falls back to shelling out to `git` if it is not present.
