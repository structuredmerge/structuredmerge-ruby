...
# kettle-jem:freeze
# To retain chunks of comments & code during ast-template templating:
...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/ast/template/version.rb", mod) }::Ast::Template::Version::VERSION
  ...
  # The 'git' gem is optional; ast-template falls back to shelling out to `git` if it is not present.
