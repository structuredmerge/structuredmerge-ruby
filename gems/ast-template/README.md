...
| Description | Product-level directory session reporting above ast-merge for Structured Merge. |
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/ast-template |
