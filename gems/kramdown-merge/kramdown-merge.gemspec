...
# kettle-jem:freeze
# To retain chunks of comments & code during kramdown-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# kramdown-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

Gem::Specification.new do |spec|
  spec.name = 'kramdown-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/kramdown/merge/version.rb", mod) }::Kramdown::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge Kramdown-backed Markdown analysis for Ruby'
  spec.description = '☯️ Kramdown-backed Markdown provider gem for the Structured Merge Markdown family.'
  ...
  # The 'git' gem is optional; kramdown-merge falls back to shelling out to `git` if it is not present.
