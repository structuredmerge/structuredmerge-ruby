...
|---|---|
| Package | bash-merge |
| Description | ☯️ Bash statement, comment, freeze-block, and template merge behavior for Structured Merge. |
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/bash-merge |
