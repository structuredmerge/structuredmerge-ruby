...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/html/merge/version.rb", mod) }::Html::Merge::Version::VERSION
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.5", ">= 2.5.24") # ruby >= 3.2.0
