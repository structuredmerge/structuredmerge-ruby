...
# kettle-jem:freeze
# To retain chunks of comments & code during parslet-toml-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# parslet-toml-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

Gem::Specification.new do |spec|
  spec.name = 'parslet-toml-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/parslet/toml/merge/version.rb", mod) }::Parslet::Toml::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge Parslet-backed TOML analysis for Ruby'
  spec.description = '☯️ Parslet-backed TOML provider gem for the Structured Merge TOML family.'
  ...
  # The 'git' gem is optional; parslet-toml-merge falls back to shelling out to `git` if it is not present.
