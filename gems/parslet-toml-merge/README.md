...
```ruby
spec.add_dependency("parslet-toml-merge", "~> 7.0")
```
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/parslet-toml-merge |
