...
# kettle-jem:freeze
# To retain chunks of comments & code during rust-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# rust-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

Gem::Specification.new do |spec|
  spec.name = 'rust-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rust/merge/version.rb", mod) }::Rust::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge Rust module analysis and merge for Ruby'
  spec.description = '☯️ Portable Rust module owner analysis and merge behavior for Structured Merge.'
  ...
  # The 'git' gem is optional; rust-merge falls back to shelling out to `git` if it is not present.
