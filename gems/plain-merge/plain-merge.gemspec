...
# kettle-jem:freeze
# To retain chunks of comments & code during plain-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# plain-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

Gem::Specification.new do |spec|
  spec.name = 'plain-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/plain/merge/version.rb", mod) }::Plain::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge plain text analysis and merge for Ruby'
  spec.description = '☯️ Portable text normalization, similarity, matching, and merge behavior for Structured Merge.'
  ...
  # The 'git' gem is optional; plain-merge falls back to shelling out to `git` if it is not present.
