...
|---|---|
| Package | plain-merge |
| Description | Portable text normalization, similarity, matching, and merge behavior for Structured Merge. |
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/plain-merge |
