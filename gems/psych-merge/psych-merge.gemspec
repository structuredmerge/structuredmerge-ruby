...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge Psych-backed YAML analysis for Ruby'
  spec.description = '☯️ Psych-backed YAML provider gem for the Structured Merge YAML family.'
