...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge TOML substrate analysis and merge for Ruby'
  spec.description = '☯️ Tree-sitter-backed TOML substrate behavior for the Structured Merge TOML family.'
