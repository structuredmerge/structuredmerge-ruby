...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge Commonmarker-backed Markdown analysis for Ruby'
  spec.description = '☯️ Commonmarker-backed Markdown provider gem for the Structured Merge Markdown family.'
