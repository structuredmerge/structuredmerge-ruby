...
Gem::Specification.new do |spec|
  ...
  spec.summary = '☯️ Structured Merge Ruby substrate analysis for Ruby'
  spec.description = '☯️ Tree-sitter-backed Ruby family substrate for Structured Merge.'
  ...
  # The 'git' gem is optional; ruby-merge falls back to shelling out to `git` if it is not present.
