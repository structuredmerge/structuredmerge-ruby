...
# kettle-jem:freeze
# To retain chunks of comments & code during yaml-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# yaml-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

Gem::Specification.new do |spec|
  spec.name = 'yaml-merge'
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/yaml/merge/version.rb", mod) }::Yaml::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge YAML analysis and merge for Ruby'
  spec.description = '☯️ Portable YAML analysis, owner matching, and merge behavior for Structured Merge.'
  ...
  # The 'git' gem is optional; yaml-merge falls back to shelling out to `git` if it is not present.
