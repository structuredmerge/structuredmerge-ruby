...
| Field | Value |
|---|---|
| Package | markly-merge |
| Description | Markly-backed Markdown provider gem for the Structured Merge Markdown family. |
...
| Funding | https://github.com/sponsors/pboling, https://tidelift.com/funding/github/rubygems/markly-merge |
