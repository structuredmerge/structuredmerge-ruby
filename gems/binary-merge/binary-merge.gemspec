...
# kettle-jem:freeze
# To retain chunks of comments & code during binary-merge templating:
...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/binary/merge/version.rb", mod) }::Binary::Merge::Version::VERSION
  spec.authors = ['Peter H. Boling']
  spec.email = ['info@structuredmerge.org']

  spec.summary = '☯️ Structured Merge binary merge contracts for Ruby'
  spec.description = '☯️ Portable binary preservation planning and diagnostics for Structured Merge.'
  ...
  # The 'git' gem is optional; binary-merge falls back to shelling out to `git` if it is not present.
